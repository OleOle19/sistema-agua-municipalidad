...
const ModalCalles = ({ cerrarModal, darkMode, canDeleteCalles = false, onFlash = null }) => {
  ...
  const agregarCalle = async () => {
    if (!nuevaCalle.nombre.trim()) {
      showFlash("warning", "Escriba un nombre para la calle.");
      return;
    }
    try {
      ...
      cargarCalles();
      showFlash("success", "Calle agregada correctamente.");
    } catch {
      showFlash("danger", "Error al agregar la calle.");
    }
  };
  ...
  const eliminarCalle = async (id) => {
    ...
    try {
      ...
      cargarCalles();
      showFlash("success", "Calle eliminada correctamente.");
    } catch (error) {
      showFlash("danger", error.response?.data?.error || "Error al eliminar la calle.");
    }
  };
  ...
  const guardarEdicion = async () => {
    try {
      ...
      cargarCalles();
      showFlash("success", "Calle actualizada correctamente.");
    } catch {
      showFlash("danger", "Error al actualizar la calle.");
    }
  };
