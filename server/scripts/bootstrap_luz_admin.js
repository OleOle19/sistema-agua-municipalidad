...
const plainPassword = plainPasswordEnv;

if (!username || !plainPassword || !nombreCompleto) {
  console.error("LUZ_ADMIN_USER, LUZ_ADMIN_PASS y LUZ_ADMIN_NOMBRE son obligatorios para crear o actualizar el admin de Luz.");
  process.exit(1);
}
