...
| Publicacion y secretos debiles | Resuelto en aplicacion y equipo local | Arranque estricto, JWT de 64 caracteres y Campo como publicacion predeterminada. El acceso completo por Quick Tunnel requiere `TRYCLOUDFLARE_FULL_APP=1`, conserva autenticacion y roles, y se limita a uso temporal; para uso permanente se recomienda VPN o HTTPS propio con controles adicionales. |
