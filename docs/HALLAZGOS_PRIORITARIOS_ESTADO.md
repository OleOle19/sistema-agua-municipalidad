...
| Adjuntos personales versionados | Resuelto en el arbol actual | `server/uploads/` esta ignorado y sin archivos rastreados. La purga del historial remoto requiere una reescritura coordinada y autorizacion expresa. |
| Backups incompletos | Resuelto localmente / operacion externa pendiente | Backup verificado con Agua, Luz, seis adjuntos y manifiesto SHA-256. Existe espejo obligatorio configurable; falta designar y validar un disco externo cifrado y ejecutar el simulacro mensual de restauracion. |
